$mavenDir = "d:/vitalink/maven-portable/apache-maven-3.9.6"
if (-not (Test-Path "$mavenDir/bin/mvn.cmd")) {
    Write-Host "Setting up portable Maven..." -ForegroundColor Green
    $url = "https://archive.apache.org/dist/maven/maven-3/3.9.6/binaries/apache-maven-3.9.6-bin.zip"
    $zipFile = "d:/vitalink/maven-portable.zip"
    $destDir = "d:/vitalink/maven-portable"
...
# Set MONGODB_URI environment variable containing the Atlas cluster connection string
